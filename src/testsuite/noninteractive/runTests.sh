...
namespace Npgsql
{
    ...
    {
	public static readonly String NPGSQL_TESTS_CONNECTIONSTRING =
    \"Server=${NPGSQL_HOST};User Id=${NPGSQL_UID};Password=${NPGSQL_PWD};Database=${NPGSQL_DB}\";
    }
}
